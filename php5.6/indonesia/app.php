        ...
        <div class="right_col" role="main">
          ...
          <section>
			...
			<? if (isset($_SESSION['last_upd_date'])): ?>
                ...
                <div class="container">           
                <ul class="pager">
                  <li class="previous"><a href="app.php?flag=images&obtained_at=<?=$previous_date->format('Y-m-d')?>"><div class="lang" key="previousday"></div></a></li>
                  <li class="next"><a href="app.php?flag=images&obtained_at=<?=$next_date->format('Y-m-d')?>"><div class="lang" key="nextday"></div></a></li>
                </ul>
              </div>
                </section>
                ...
                <div class="container">           
                <ul class="pager">
                  <button type="button" value="<?=MAX_IMAGES?>" class="btn btn-primary" id="load_more" onclick="load_more_data()"><div class="lang" key="load"></div></button>
                </ul>
              </div>
                </section>              
              <div class="clearfix"></div>
